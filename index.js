...
var message = randomString(address);

console.log("Please Sign a Message With This String of words : '" + message + "'");
console.log("---------------------------------------------------------------------------------")
console.log("Please Supply The Following Information from your message")
var signature = readline.question("Signature : ");
console.log("---------------------------------------------------------------------------------")


if(check(signature, message, address)) {
  console.log("Verified Account : " + address + " Belongs to you. ")
} else{
  console.log("Not Verified You Fucking Scammer")
}

function check(sgn, msg, adr){


            var sig = new Buffer(sgn.toLowerCase().replace('0x', ''), 'hex');
            ...
            if (adr.toLowerCase().replace('0x', '') != ethUtil.pubToAddress(pubKey).toString('hex')) return false; else {
              return true;
            }
